 ...
 */
function jason_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['jason_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('jason sample setting'),
  '#default_value' => theme_get_setting('jason_example'),
