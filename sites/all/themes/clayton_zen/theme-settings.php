 ...
 */
function clayton_zen_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['clayton_zen_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('clayton_zen sample setting'),
  '#default_value' => theme_get_setting('clayton_zen_example'),
