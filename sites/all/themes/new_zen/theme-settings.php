 ...
 */
function new_zen_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['new_zen_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('new_zen sample setting'),
  '#default_value' => theme_get_setting('new_zen_example'),
