 ...
 */
function morezen_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['morezen_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('morezen sample setting'),
  '#default_value' => theme_get_setting('morezen_example'),
