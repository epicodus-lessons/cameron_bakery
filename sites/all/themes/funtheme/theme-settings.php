 ...
 */
function funtheme_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['funtheme_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('funtheme sample setting'),
  '#default_value' => theme_get_setting('funtheme_example'),
