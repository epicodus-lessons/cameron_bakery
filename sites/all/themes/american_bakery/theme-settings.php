 ...
 */
function american_bakery_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['american_bakery_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('american_bakery sample setting'),
  '#default_value' => theme_get_setting('american_bakery_example'),
