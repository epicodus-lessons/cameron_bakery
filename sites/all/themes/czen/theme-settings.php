 ...
 */
function czen_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['czen_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('czen sample setting'),
  '#default_value' => theme_get_setting('czen_example'),
