 ...
 */
function bakeryzen_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['bakeryzen_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('bakeryzen sample setting'),
  '#default_value' => theme_get_setting('bakeryzen_example'),
