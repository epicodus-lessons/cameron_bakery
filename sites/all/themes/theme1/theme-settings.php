 ...
 */
function theme1_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['theme1_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('theme1 sample setting'),
  '#default_value' => theme_get_setting('theme1_example'),
