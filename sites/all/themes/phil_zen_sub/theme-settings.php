 ...
 */
function phil_zen_sub_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['phil_zen_sub_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('phil_zen_sub sample setting'),
  '#default_value' => theme_get_setting('phil_zen_sub_example'),
