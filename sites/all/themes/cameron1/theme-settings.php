 ...
 */
function cameron1_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['cameron1_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('cameron1 sample setting'),
  '#default_value' => theme_get_setting('cameron1_example'),
