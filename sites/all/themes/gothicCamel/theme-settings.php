 ...
 */
function gothicCamel_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['gothicCamel_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('gothicCamel sample setting'),
  '#default_value' => theme_get_setting('gothicCamel_example'),
