 ...
 */
function camzen_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['camzen_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('camzen sample setting'),
  '#default_value' => theme_get_setting('camzen_example'),
