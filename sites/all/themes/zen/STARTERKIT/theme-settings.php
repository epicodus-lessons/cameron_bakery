 ...
 */
function clean_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['clean_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('clean sample setting'),
  '#default_value' => theme_get_setting('clean_example'),
