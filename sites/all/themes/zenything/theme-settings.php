 ...
 */
function zenything_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['zenything_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('zenything sample setting'),
  '#default_value' => theme_get_setting('zenything_example'),
