 ...
 */
function camerontheme_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['camerontheme_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('camerontheme sample setting'),
  '#default_value' => theme_get_setting('camerontheme_example'),
