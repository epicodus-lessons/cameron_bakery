 ...
 */
function zen_custom_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['zen_custom_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('zen_custom sample setting'),
  '#default_value' => theme_get_setting('zen_custom_example'),
