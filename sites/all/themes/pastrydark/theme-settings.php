 ...
 */
function pastrydark_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['pastrydark_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('pastrydark sample setting'),
  '#default_value' => theme_get_setting('pastrydark_example'),
