 ...
 */
function onetheme_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['onetheme_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('onetheme sample setting'),
  '#default_value' => theme_get_setting('onetheme_example'),
