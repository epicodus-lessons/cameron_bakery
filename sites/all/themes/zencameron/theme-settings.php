 ...
 */
function zencameron_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['zencameron_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('zencameron sample setting'),
  '#default_value' => theme_get_setting('zencameron_example'),
